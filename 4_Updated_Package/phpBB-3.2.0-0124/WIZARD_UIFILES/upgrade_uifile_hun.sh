...
wizard_db_settings="phpBB adatbázis telepítése"
wizard_db_name_desc="Kérjük, adja meg az adatbázis nevét a phpBB-adatbázishoz. "
wizard_db_name_label="Adatbázis neve"
wizard_m10_desc="Adja meg a MariaDB 10 rendszergazdai hitelesítő adatait a(z) phpBB adatbázis beállításának folytatásához."
wizard_admin_acc="Fiók"
wizard_admin_pass="Jelszó"
wizard_set_db_desc="Ha meglévő/új adatokat szeretne használni, hozzon létre egy új exkluzív adatbázisfiókot a következőhöz: phpBB."
wizard_set_data_title="Beállítás phpBB"
wizard_found_backup="Válasszon egy módszert az adatok importálásához."
wizard_decide_restore="phpBB adatbázis már létezik.<br>Válasszon az alábbi műveletek közül:"
...
wizard_migrate_note="A(z) phpBB legújabb verziója csak a MariaDB 10 programot támogatja.<br>A rendszer észlelt egy meglévő MariaDB 5 adatbázist.<br>A következő lépésben az adatbázist a MariaDB 5 alól áttelepítjük a MariaDB 10 alá.<br><br>A telepítés folytatásához adja meg a MariaDB 5 rendszergazdai hitelesítő adatait."
wizard_migrate_title="phpBB adatbázis áttelepítése"
wizard_remove_msql_title="phpBB–adatbázis eltávolítása"
wizard_remove_msql_desc="A(z) phpBB adatbázis eltávolításával az összes adatot is törli a rendszer."
wizard_msql_password_desc_remove="A phpBB-adatbázis eltávolításához adja meg az adatbázis-rendszergazdához tartozó bejelentkezési adatokat."
wizard_admin_acc="Fiók"
wizard_admin_pass="Jelszó"
PageM5()
{
