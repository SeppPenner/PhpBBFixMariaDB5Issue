...
wizard_db_settings="Skonfiguruj bazę danych phpBB"
wizard_db_name_desc="Wprowadź nazwę bazy danych phpBB."
wizard_db_name_label="Nazwa bazy danych"
wizard_m10_desc="Wprowadź poświadczenia administratora MariaDB 10, aby kontynuować konfigurację bazy danych phpBB."
wizard_admin_acc="Konto"
wizard_admin_pass="Hasło"
wizard_set_db_desc="Utwórz nowe odrębne konto bazy danych dla phpBB, aby użyć istniejących/nowych danych."
wizard_set_data_title="Konfiguruj phpBB"
wizard_found_backup="Wybierz metodę importu danych."
wizard_decide_restore="phpBB — baza danych już istnieje.<br>Wybierz dowolną z następujących akcji:"
...
wizard_migrate_note="Najnowsza wersja phpBB obsługuje tylko aplikację MariaDB 10.<br>System wykrył jedynie istniejąca bazę danych MariaDB 5.<br>W kolejnym kroku nastąpi migracja bazy danych z MariaDB 5 do MariaDB 10.<br><br>Wprowadź poświadczenia administratora MariaDB 5, aby kontynuować instalację."
wizard_migrate_title="Migruj bazę danych phpBB"
wizard_remove_msql_title="Usuń bazę danych phpBB"
wizard_remove_msql_desc="Po usunięciu bazy danych phpBB wszystkie dane zostaną usunięte."
wizard_msql_password_desc_remove="Wprowadź poświadczenia administratora bazy danych, aby usunąć bazę danych phpBB."
wizard_admin_acc="Konto"
wizard_admin_pass="Hasło"
PageUninst()
{
