...
wizard_db_settings="phpBB-database instellen"
wizard_db_name_desc="Voer de databasenaam voor de phpBB-database in.   "
wizard_db_name_label="Databasenaam"
wizard_m10_desc="Voer de gebruikersgegevens van de administrator van MariaDB 10 in om door te gaan met de phpBB-database-instellingen."
wizard_admin_acc="Account"
wizard_admin_pass="Wachtwoord"
wizard_set_db_desc="Gebruik bestaande/nieuwe gegevens om een nieuwe exclusieve database-account voor phpBB te maken."
wizard_set_data_title="phpBB instellen"
wizard_found_backup="Selecteer een methode om gegevens te importeren."
wizard_decide_restore="De phpBB-database bestaat al.<br>Selecteer een van de volgende handelingen:"
...
wizard_migrate_note="Alleen de laatste versie van phpBB ondersteunt MariaDB 10.<br>Het systeem heeft een bestaande MariaDB 5-database gedetecteerd.<br>In de volgende stap wordt uw database van MariaDB 5 naar MariaDB 10 gemigreerd.<br><br>Voer de gebruikersgegevens van de administrator van MariaDB 5 om door te gaan met de installatie."
wizard_migrate_title="phpBB-database migreren"
wizard_remove_msql_title="phpBB-database verwijderen"
wizard_remove_msql_desc="Bij verwijdering van de phpBB-database worden alle gegevens verwijderd."
wizard_msql_password_desc_remove="Voer de gegevens van de databaseadministrator in om de phpBB-database te verwijderen."
wizard_admin_acc="Account"
wizard_admin_pass="Wachtwoord"
PageUninst()
{
