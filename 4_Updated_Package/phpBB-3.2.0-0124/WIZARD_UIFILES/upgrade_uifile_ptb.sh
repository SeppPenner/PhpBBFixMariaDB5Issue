...
wizard_db_settings="Configurar banco de dados do phpBB"
wizard_db_name_desc="Digite o nome do banco de dados do phpBB."
wizard_db_name_label="Nome do banco de dados"
wizard_m10_desc="Insira as credenciais de administrador do MariaDB 10 para prosseguir com as configurações do banco de dados do phpBB."
wizard_admin_acc="Conta"
wizard_admin_pass="Senha"
wizard_set_db_desc="Crie uma conta nova e exclusiva de banco de dados para o phpBB usar dados existentes/novos."
wizard_set_data_title="Configurar phpBB"
wizard_found_backup="Selecione um método parar importar os dados."
wizard_decide_restore="phpBB o bando de dados já existe.<br>Selecione uma das seguintes ações:"
...
wizard_migrate_note="A versão mais recente do phpBB só oferece suporte ao MariaDB 10.<br>O sistema detectou um banco de dados já existente do MariaDB 5.<br>Na próxima etapa, o banco de dados será migrado do MariaDB 5 para o MariaDB 10.<br><br>Insira as credenciais de administrador do MariaDB 5 para prosseguir com a instalação."
wizard_migrate_title="Migrar banco de dados do phpBB"
wizard_remove_msql_title="Remover banco de dados do phpBB"
wizard_remove_msql_desc="Se o banco de dados do phpBB for removido, todos os dados serão excluídos."
wizard_msql_password_desc_remove="Digite as credenciais do administrador de banco de dados para remover o banco de dados do phpBB."
wizard_admin_acc="Conta"
wizard_admin_pass="Senha"
PageM5()
{
