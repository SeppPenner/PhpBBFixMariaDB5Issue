...
wizard_db_settings="设置 phpBB 数据库"
wizard_db_name_desc="请为 phpBB 数据库输入数据库名称。 "
wizard_db_name_label="数据库名称"
wizard_m10_desc="请输入 MariaDB 10 管理员的帐户密码，继续 phpBB 数据库设置。"
wizard_admin_acc="帐号"
wizard_admin_pass="密码"
wizard_set_db_desc="若要使用现有/全新数据，请为 phpBB 创建数据库专属帐户。"
wizard_set_data_title="设置 phpBB"
wizard_found_backup="请选择数据导入方式。"
wizard_decide_restore="phpBB 数据库已存在。<br>请选择下列操作之一："
...
wizard_migrate_note="最新版本的 phpBB 仅支持 MariaDB 10。<br>系统已检测到现有 MariaDB 5 数据库。<br>在下一步中，系统会将 MariaDB 5 数据库迁移至 MariaDB 10。<br><br>请输入 MariaDB 5 管理员的帐户密码，以继续安装。"
wizard_migrate_title="迁移 phpBB 数据库"
wizard_remove_msql_title="删除 phpBB 数据库"
wizard_remove_msql_desc="如果移除 phpBB 数据库，所有数据将会删除。"
wizard_msql_password_desc_remove="请输入数据库管理员的用户凭据以删除 phpBB 数据库。"
wizard_admin_acc="帐号"
wizard_admin_pass="密码"
PageM5()
{
