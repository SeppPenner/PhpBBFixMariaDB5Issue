...
wizard_db_settings="Configurare il database phpBB"
wizard_db_name_desc="Immettere il nome database per il database phpBB."
wizard_db_name_label="Nome database"
wizard_m10_desc="Inserire le credenziali amministratore di MariaDB 10 per procedere con le impostazioni del database phpBB."
wizard_admin_acc="Account"
wizard_admin_pass="Password"
wizard_set_db_desc="Creare un nuovo account database esclusivo per phpBB per usare i dati nuovi/esistenti."
wizard_set_data_title="Configurare phpBB"
wizard_found_backup="Selezionare un metodo per importare i dati."
wizard_decide_restore="Il database phpBB esiste già.<br>Selezionare una delle seguenti azioni:"
...
wizard_migrate_note="L'ultima versione di phpBB supporta solo MariaDB 10.<br>Il sistema ha rilevato un database MariaDB 5 esistente.<br>Nel prossimo passaggio, il database sarà migrato da MariaDB 5 a MariaDB 10.<br><br>Inserire le credenziali amministratore di MariaDB 5 per procedere con l'installazione."
wizard_migrate_title="Migrare il database phpBB"
wizard_remove_msql_title="Rimuovi database phpBB"
wizard_remove_msql_desc="Se il database phpBB viene rimosso, tutti i dati saranno eliminati."
wizard_msql_password_desc_remove="Inserire le credenziali dell'amministratore del database per rimuovere il database phpBB."
wizard_admin_acc="Account"
wizard_admin_pass="Password"
PageM5()
{
