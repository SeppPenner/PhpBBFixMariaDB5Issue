...
wizard_db_settings="Nastavit databázi phpBB"
wizard_db_name_desc="Zadejte název databáze phpBB. "
wizard_db_name_label="Název databáze"
wizard_m10_desc="Chcete-li pokračovat v nastavení databáze phpBB, zadejte přihlašovací údaje správce pro databázi MariaDB 10."
wizard_admin_acc="Účet"
wizard_admin_pass="Heslo"
wizard_set_db_desc="Chcete-li použít stávající nebo nová data, vytvořte nový vyhrazený účet databáze pro aplikaci phpBB."
wizard_set_data_title="Nastavit phpBB"
wizard_found_backup="Vyberte způsob importu dat."
wizard_decide_restore="phpBB databáze již existuje.<br>Vyberte některou z následujících akcí:"
...
wizard_migrate_note="Nejnovější verze aplikace phpBB podporuje pouze databázi MariaDB 10.<br>Systém nalezl stávající databázi MariaDB 5.<br>V následujícím kroku bude vaše databáze migrována z verze MariaDB 5 do verze MariaDB 10.<br><br>Chcete-li pokračovat v instalaci, zadejte přihlašovací údaje správce pro databázi MariaDB 5."
wizard_migrate_title="Migrace databáze phpBB"
wizard_remove_msql_title="Odebrat databázi phpBB"
wizard_remove_msql_desc="Pokud odeberete databázi phpBB, odstraní se veškerá data."
wizard_msql_password_desc_remove="Databázi phpBB bude možné odebrat po zadání přihlašovacích údajů správce databáze."
wizard_admin_acc="Účet"
wizard_admin_pass="Heslo"
PageM5()
{
