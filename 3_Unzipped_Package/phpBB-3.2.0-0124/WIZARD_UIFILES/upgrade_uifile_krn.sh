...
wizard_db_settings="phpBB 데이터베이스 설정"
wizard_db_name_desc="Please enter database name for phpBB."
wizard_db_name_label="데이터베이스 이름"
wizard_m10_desc="phpBB 데이터베이스 설정을 진행하려면 MariaDB 10의 관리자 자격 증명을 입력하십시오."
wizard_admin_acc="계정"
wizard_admin_pass="패스워드"
wizard_set_db_desc="기존/새 데이터를 사용하려면 phpBB에 대한 새 독점 데이터베이스 계정을 만드십시오."
wizard_set_data_title="설정 phpBB"
wizard_found_backup="데이터를 가져올 방법을 선택하십시오."
wizard_decide_restore="phpBB 데이터베이스가 이미 있습니다.<br>다음 작업 중 하나를 선택하십시오."
...
wizard_migrate_note="phpBB의 최신 버전은 MariaDB 10만 지원합니다.<br>시스템에서 기존 MariaDB 5 데이터베이스를 감지했습니다.<br>다음 단계에서는 데이터베이스가 MariaDB 5에서 MariaDB 10으로 마이그레이션됩니다.<br><br>설치를 진행하려면 MariaDB 5의 관리자 자격 증명을 입력하십시오."
wizard_migrate_title="phpBB 데이터베이스 마이그레이션"
wizard_remove_msql_title="phpBB 데이터베이스 제거"
wizard_remove_msql_desc="phpBB 데이터베이스가 제거되면 모든 데이터가 삭제됩니다."
wizard_msql_password_desc_remove="phpBB 데이터베이스를 제거하려면 데이터베이스 관리자 자격 증명을 입력하십시오."
wizard_admin_acc="계정"
wizard_admin_pass="패스워드"
PageM5()
{
