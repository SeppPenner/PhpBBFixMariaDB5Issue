...
wizard_db_settings="phpBBデータベースをセットアップ"
wizard_db_name_desc="phpBB データベースの名前を入力してください。 "
wizard_db_name_label="データベース名"
wizard_m10_desc="MariaDB 10の管理者の資格情報を入力してからphpBBデータベース設定に進んでください。"
wizard_admin_acc="アカウント"
wizard_admin_pass="パスワード"
wizard_set_db_desc="新しい排他的データベースをphpBBに作成してから既存/新規のデータを使用してください。"
wizard_set_data_title="phpBBをセットアップ"
wizard_found_backup="データをインポートする方法を選択してください。"
wizard_decide_restore="phpBB データベースはすでに存在します。<br>以下のいずれかの操作を選択してください。"
...
wizard_migrate_note="phpBBの最新バージョンはMariaDB 10のみをサポートします。<br>システムが既存のMariaDB 5データベースを検出しました。<br>次のステップで、データベースはMariaDB 5からMariaDB 10に移行します。<br><br>MariaDB 5のadminの資格情報を入力してからインストールに進んでください。"
wizard_migrate_title="phpBBデータベースを移行"
wizard_remove_msql_title="phpBB データベースを削除"
wizard_remove_msql_desc="phpBB データベースを削除すると、すべてのデータが削除されます。"
wizard_msql_password_desc_remove="phpBB データベースを削除するには、データベースの管理者の認証情報を入力してください。"
wizard_admin_acc="アカウント"
wizard_admin_pass="パスワード"
PageUninst()
{
